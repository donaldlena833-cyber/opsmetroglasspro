...
export function BottomNav() {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-dark-card border-t border-gray-200 dark:border-dark-border safe-bottom">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? 'text-navy-800 dark:text-dark-text' : 'text-gray-400 dark:text-dark-muted'
                )}
              >
