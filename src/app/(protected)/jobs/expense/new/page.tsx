  ...
  return (
    <div className="page-container safe-top">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-bold text-navy-800">Add Expense</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardContent>
            <label className="block">
              <p className="text-sm font-medium text-navy-800 mb-2">Receipt Image</p>
              {receiptPreview ? (
                ...
                <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center cursor-pointer hover:border-orange-300 transition-colors">
        ...
        <Card>
          <CardContent className="space-y-4">
            ...
            <Input
              label="Vendor *"
              placeholder="Mr Glass, C.R. Laurence, U-Haul..."
              value={vendor}
