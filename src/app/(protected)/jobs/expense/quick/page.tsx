...
import { ArrowLeft, Camera, Loader2, Sparkles, Search } from 'lucide-react'
  ...
  return (
    <div className="page-container safe-top">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-bold text-navy-800">Quick Expense</h1>
      </div>
      ...
      {step === 'camera' && (
        <div className="flex flex-col items-center justify-center min-h-[50vh]">
          <button
            ...
            className="w-32 h-32 rounded-full bg-orange-500 text-white flex items-center justify-center shadow-lg active:scale-95 transition-transform"
          >
            <Camera className="w-12 h-12" />
          </button>
          <p className="text-gray-500 mt-4">Tap to take a photo of your receipt</p>
        </div>
      )}
